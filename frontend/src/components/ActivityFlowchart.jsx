...
export default function ActivityFlowchart({ timeline, candidateName }) {
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-base font-extrabold text-white flex items-center gap-2">
              <span>AI Activity Flowchart Journey</span>
      ...
      <div className="bg-gradient-to-r from-indigo-950/90 via-purple-950/60 to-slate-950 border border-indigo-500/40 p-3.5 rounded-xl space-y-1.5 shadow-lg">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[9px] bg-emerald-950 text-emerald-300 border border-emerald-500/40 font-mono font-bold px-2 py-0.5 rounded-full">
            100% VERIFIED FOOTPRINT
          </span>
        </div>
        <p className="text-[11px] text-slate-300 leading-relaxed font-normal">
          AI synthesized a <span className="text-white font-semibold">{events.length}-step chronological flowchart</span> covering academic foundation at PRMITR Badnera, research publications, hackathon wins, open-source repositories, and LinkedIn articles.
        </p>
      </div>
            ...
            <div key={idx} className="relative space-y-2">
              ...
              {!isLast && (
                <div className="flex justify-center py-1">
                  <div className="flex items-center gap-1 bg-slate-950 border border-indigo-500/30 px-2 py-0.5 rounded-full text-indigo-400 text-[10px] font-mono shadow-sm">
